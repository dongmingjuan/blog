...
class Admin::GroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_group" do
    assert_difference('Admin::Group.count') do
      post admin_groups_url, params: { admin_group: { description: @admin_group.description, title: @admin_group.title } }
    end
  ...
  test "should update admin_group" do
    patch admin_group_url(@admin_group), params: { admin_group: { description: @admin_group.description, title: @admin_group.title } }
